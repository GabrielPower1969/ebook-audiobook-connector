...
Machine-specific status — what is built on this laptop, deployment hostnames, the current library —
lives in `NOTES.local.md`, which is git-ignored. This file stays the architecture map so it is
useful to anyone who clones the repo.
